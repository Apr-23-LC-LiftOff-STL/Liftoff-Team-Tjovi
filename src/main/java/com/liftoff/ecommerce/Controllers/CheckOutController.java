...
public class CheckOutController {
    ...
    public Map<String,String> checkout() throws StripeException {
        ...
        PaymentIntentCreateParams params= PaymentIntentCreateParams.builder().setAmount(100L).setCurrency("usd").setAutomaticPaymentMethods(PaymentIntentCreateParams.AutomaticPaymentMethods.builder().setEnabled(true).build()).build();
