...
//
//    //Allows us to retrieve login status of user in our AuthenticationFiler to determine if user is logged in or not
...
//    }
//
//    //Uses HttpSession object to store key/value pair, of userSessionKey and userId- logins in user after register/login
